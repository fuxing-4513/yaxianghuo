    ...
    <div className="min-h-screen bg-rich-950">
      ...
      <section className="relative pt-24 pb-16 border-b border-burma-400/5">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          <span className="text-[11px] text-burma-400 tracking-[0.25em] uppercase">About</span>
      ...
      <section className="max-w-5xl mx-auto px-6 py-24">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            <span className="text-[11px] text-burma-400 tracking-[0.25em] uppercase">Brand Story</span>
            <h2 className="text-2xl font-serif font-bold text-ivory-100 mt-3 mb-6">缅甸之灵，德宏之韵</h2>
          ...
          <div className="relative">
            <div className="aspect-square bg-gradient-to-br from-jade-950/40 via-rich-800 to-burma-900/15 rounded-xl border border-burma-400/10 flex items-center justify-center overflow-hidden">
              <div className="absolute inset-0 bg-burma-pattern opacity-30" />
              <div className="relative z-10 text-center p-12">
                ...
                <p className="text-xs text-burma-400/60 leading-relaxed">
                  缅甸帕敢矿区<br />亿万年地质淬炼<br />只为这一刻的相遇
                </p>
              </div>
            </div>
            {/* 装饰环 */}
            <div className="absolute -inset-4 border border-burma-400/5 rounded-xl -z-10" />
          </div>
        </div>
      </section>

      {/* 德宏与缅甸 */}
      <section className="border-t border-burma-400/5 bg-rich-800/30">
        <div className="max-w-5xl mx-auto px-6 py-24">
          <div className="text-center mb-16">
            <span className="text-[11px] text-burma-400 tracking-[0.25em] uppercase">Where We Are</span>
            <h2 className="text-2xl font-serif font-bold text-ivory-100 mt-3 mb-4">德宏 · 中缅边境翡翠门户</h2>
            <div className="divider-gold-center mb-6" />
          </div>

          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-rich-800/60 border border-rich-600/40 rounded-xl p-8">
              <h3 className="text-lg font-serif font-bold text-burma-300 mb-4">🇲🇲 缅甸帕敢</h3>
            ...
            <div className="bg-rich-800/60 border border-rich-600/40 rounded-xl p-8">
              <h3 className="text-lg font-serif font-bold text-burma-300 mb-4">🇨🇳 云南德宏</h3>
              <p className="text-xs text-gray-400 leading-relaxed mb-4">
      ...
      {/* 联系我们 */}
      <section id="contact" className="border-t border-burma-400/5">
        <div className="max-w-5xl mx-auto px-6 py-24">
          <div className="text-center mb-16">
            <span className="text-[11px] text-burma-400 tracking-[0.25em] uppercase">Contact</span>
            <h2 className="text-2xl font-serif font-bold text-ivory-100 mt-3 mb-4">联系我们</h2>
            <div className="divider-gold-center mb-6" />
            <p className="text-gray-400 text-sm">预约专属私洽服务 · 线下品鉴 · 藏品咨询</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            {[
              ...
              <div key={i} className="bg-rich-800/60 border border-rich-600/40 rounded-xl p-8 text-center hover:border-burma-400/15 transition-colors">
                <span className="text-3xl mb-4 block">{c.icon}</span>
                <h3 className="text-sm font-semibold text-ivory-100 mb-3">{c.title}</h3>
                <p className="text-xs text-gray-500 leading-relaxed whitespace-pre-line">{c.content}</p>
              </div>
            ))}
          </div>
